  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
      ...
      <div className="space-y-3">
        ...
        {/* Footer */}
        <div className="flex items-center justify-between pt-3 border-t border-ember-card-border  text-xs">
      ...
      <div className="flex flex-col justify-between gap-4">
        <div className="space-y-5">
          ...
          <div className="space-y-1.5">
            <label className="text-sm text-ember-muted">
              Weight (kg)
            </label>
            <div className="relative">
              <input
                ...
                className="w-full bg-transparent border-0 border-b border-ember-card-border px-0 py-2 pr-10 text-sm  text-ember-ink placeholder:text-ember-muted focus:outline-none focus:border-ember-amber transition-colors disabled:opacity-50"
              />
              <span className="absolute right-0 top-1/2 -translate-y-1/2 text-xs  text-ember-muted pointer-events-none">
                kg
              </span>
            </div>
          </div>
          ...
          <div className="border-t border-ember-card-border pt-4 ">
            {baselineTdee ? (
              <>
                <p className="text-sm text-ember-muted mb-1">Current TDEE</p>
                <p className="text-lg text-ember-ink tabular-nums">{baselineTdee.toLocaleString()} kcal</p>
                <p className="text-xs text-ember-muted mt-0.5">recalibrates after 2+ weigh-ins</p>
              </>
            ) : (
              <>
                <p className="text-sm text-ember-muted mb-1">How it works</p>
        ...
        <div className="space-y-2 ">
          <button
            ...
            className="w-full bg-ember-ink text-ember-page py-3 text-sm uppercase tracking-wide transition-opacity hover:opacity-90 disabled:opacity-30 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          >
            {saved ? (
          ...
          {existingEntry && !saved && (
            <button
              ...
              className="w-full flex items-center justify-center gap-2 py-2.5 text-sm text-ember-amber border border-ember-amber/30 hover:bg-ember-amber/5 transition-colors disabled:opacity-40"
            >
